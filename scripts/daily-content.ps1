...
3. 각 글을 Write 도구로 작성 (generate-content.mjs 사용 X):
   ...
   - 프론트매터:
     ...
     - **author 는 카테고리별 다른 팀명 (단일 author 100% 는 AdSense AI-farm 시그널, 2026-05-30 강제)**:
       ...
       - travel → `"헬스픽 여행팀"`
       - study → `"헬스픽 학습팀"`
     - tldr 3~4개 (결론 핵심), faqs 4~5개, sources 2~3개,
   ...
   - **🚫 AI 시그널 표현 금지 (2026-05-30 강화 — AdSense Low value content 방지)**:
     Google ML 이 "scaled AI content farm" 으로 인식하는 표현. 본문에서 절대 사용 금지.
     - **메타 자기참조 절대 금지**: "본 글", "본 문서", "본 페이지", "본 정리", "이 글에서는", "본 글에서는"
       → 대신 직접 답·정보 제시 (메타 언급 자체를 안 하는 게 자연스러움)
     - **AI 정형 마무리 절대 금지**: "결론적으로", "종합하면", "종합적으로", "이상으로 살펴본 바와 같이",
       "다음과 같이 정리할 수 있다", "이를 통해 알 수 있는 점은"
       → "결론부터" H2 섹션 자체가 결론이라 본문에서 또 정리 X
     - **formal 어미 한 글에서 5회 초과 금지** (`~할 수 있습니다.` / `~권장됩니다.` / `~필요합니다.` /
       `~있을 수 있습니다.`):
       글 한 편에서 위 4개 어미 합쳐서 5회 넘으면 양산형 시그널. 다양화:
       - "~할 수 있습니다." → 일부는 "~한다." / "~된다." / "~쓸 수 있다." / "~검토할 수 있다."
       - "~권장됩니다." → "~권장된다." / "~추천된다." / "~받는 게 안전하다." / "~선택지가 된다."
       - "~필요합니다." → "~필요하다." / "~있어야 한다." / "~꼭 확인해야 한다."
       - "~있을 수 있습니다." → "~있다." / "~가능하다." / "~나타나기도 한다."
     - **transitional phrase 빈도 제한**: "따라서·또한·한편·그러나" 한 글에서 합쳐 8회 초과 금지.
       자연스러운 한국어는 transitional 표지가 적음.
     - **문장 길이 다양화**: 모든 문장이 30~50자 균일하면 AI 패턴. 짧은 문장(10~20자) 과
       긴 문장(60~80자) 을 의식적으로 섞어 사용.
