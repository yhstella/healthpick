...
가능합니다. 지방간은 식이·운동 개선으로 가역적인 변화가 가능한 상태입니다. 특히 아직 염증·섬유화가 없는 단순 지방간 단계에서는 생활습관 개선만으로도 등급이 내려가는 사례가 흔합니다. 다만 이미 간섬유화가 동반된 경우에는 회복 속도가 더 느리고, 의사의 적극적인 모니터링이 필요합니다.
