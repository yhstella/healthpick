...
**Q1. 오일 교환 경고등이 뜨기 전에 갈아야 하나요?**
경고등이 뜨기 전에 갈아야 합니다. 오일 수명 경고등은 오일이 이미 권장 한계에 도달했음을 알리는 것이지, 여유 있을 때 알려주는 것이 아닙니다. 계기판에 남은 수명 %가 표시되는 차량은 20~25% 이상 여유 있을 때 교환을 권장합니다.

**Q2. 오일 교환 시 오일 필터도 함께 교환해야 하나요?**
제조사 대부분이 오일 교환마다 필터를 함께 교환하도록 권장합니다. 필터 단독 비용이 1~3만원 수준이므로, 오일 교환 시 함께 교체하는 것이 경제적입니다.

**Q3. 터보 엔진 차량은 오일 교환 주기를 더 짧게 해야 하나요?**
터보 엔진은 고온·고압 환경으로 오일 열화가 빠를 수 있습니다. 일부 제조사는 터보 차량에 더 짧은 교환 주기를 권장하기도 합니다. 매뉴얼에서 터보 엔진 전용 기준이 별도로 명시됐는지 확인하세요.

**Q4. 연비가 나빠졌는데 오일 교환이 원인일 수 있나요?**
오일이 오래되어 점도가 높아지면 엔진 내부 마찰이 증가해 연비가 소폭 악화될 수 있습니다. 다만 연비 저하의 원인은 타이어 공기압, 에어 필터, 연료계 문제 등 다양하므로 오일만으로 판단하기 어렵습니다.

**Q5. 출고 직후 첫 오일 교환은 언제 해야 하나요?**
일부 차주들은 출고 후 1000~2000km 시점에 '초기 금속 가루 제거' 목적으로 오일을 조기 교환합니다. 국내 제조사 대부분은 공식적으로 이를 권장하지 않으며, 출고 후 첫 정기 교환 주기(10000km 또는 1년)를 따르도록 안내합니다. 그러나 심리적 안심을 위해 3000~5000km에 한 번 교환하는 것을 완전히 막을 이유도 없습니다.
