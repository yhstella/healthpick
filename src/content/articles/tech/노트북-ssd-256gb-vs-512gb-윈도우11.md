...
용도별 권장 용량을 구분하면, 문서·인터넷·영상 시청만 하는 경량 사용자는 256GB로 가능하지만 여유가 없습니다. 오피스 365, Zoom, 클라우드 연동 위주의 직장인은 256GB로 가능하지만 512GB를 선택하면 훨씬 편합니다. 포토샵·일러스트레이터·라이트룸 등 크리에이티브 소프트웨어 사용자는 512GB 이상을 권장합니다. 게임 2~3개 이상 설치 예정이라면 512GB도 부족할 수 있으며 1TB를 권장합니다. 영상 편집 및 소스 파일 로컬 저장 사용자는 1TB 이상이 필요합니다.
