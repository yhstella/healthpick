...
**Q1. 구글 포토에 올린 사진을 나중에 지울 수 있나요?**
네, 구글 포토에서 사진을 삭제하면 60일간 휴지통에 보관된 후 완전히 삭제됩니다. 단, 기기 내 사진도 함께 삭제할지 묻는 경우가 있으므로 주의가 필요합니다.

**Q2. 아이클라우드 사진을 윈도우 PC에서 보려면 어떻게 해야 하나요?**
Windows용 iCloud 앱을 설치하면 아이클라우드 사진을 PC의 사진 폴더와 동기화할 수 있습니다. Microsoft Store에서 무료로 다운로드 가능합니다.

**Q3. 네이버 MYBOX는 PC 자동 백업도 되나요?**
네이버 MYBOX PC 앱을 설치하면 지정한 폴더를 자동 동기화할 수 있습니다. 스마트폰 사진 백업은 MYBOX 앱에서 '자동 올리기' 기능을 활성화하면 됩니다.

**Q4. 사진 백업 시 위치 정보도 함께 저장되나요?**
세 서비스 모두 사진에 포함된 GPS 메타데이터(EXIF)를 그대로 보존합니다. 위치 정보 공개가 걱정된다면 공유 전 메타데이터를 제거하는 앱을 활용하거나, 서비스 공유 설정에서 위치 정보 포함 여부를 확인하세요.

**Q5. 한 서비스에서 다른 서비스로 사진을 이전하기 쉬운가요?**
구글은 Google Takeout 서비스를 통해 전체 사진을 다운로드할 수 있습니다. 아이클라우드에서 전체 사진 다운로드는 iCloud.com에서 가능합니다. 다만 3만 장을 이전하는 작업은 시간이 많이 걸리므로, 처음부터 장기 사용할 서비스를 신중히 선택하는 것이 좋습니다.
