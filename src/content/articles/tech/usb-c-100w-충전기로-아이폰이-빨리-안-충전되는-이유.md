...
아이폰의 최대 충전 입력 전력은 모델마다 다릅니다. 공식 발표 수치가 아닌 실측 기반 데이터이므로 일부 편차가 있을 수 있습니다.
...
**Q1. 100W 충전기를 노트북과 아이폰에 동시에 쓸 때 아이폰 충전이 더 느려지나요?**
멀티포트 충전기는 포트별로 출력을 나눕니다. 노트북이 70~80W를 쓰고 있으면 아이폰에 할당되는 전력이 줄어 충전이 느려질 수 있습니다. 아이폰 단독 포트를 따로 쓰거나, 노트북 연결 없이 아이폰만 충전하면 최대 입력을 안정적으로 받을 수 있습니다.

**Q2. 아이폰 16이 아이폰 15보다 충전이 빠르다고 하던데 실제로 차이가 크나요?**
제조사 공식 발표 기준으로 아이폰 16 Pro 시리즈가 이전 세대보다 소폭 빠른 충전을 지원합니다. 실측 기준으로 0→50% 충전 시간이 약 5~10분 단축되는 수준입니다. 체감할 수 있는 차이지만 劇적인 차이는 아닙니다.

**Q3. 무선 충전(MagSafe)이 유선보다 느린 이유가 뭔가요?**
MagSafe는 아이폰 15·16 기준 최대 25W를 지원한다고 알려져 있지만, 발열 관리 때문에 실제 평균 전달 전력은 그보다 낮게 유지됩니다. 무선 충전 패드 자체의 변환 손실도 있어, 동일 조건에서는 유선이 빠릅니다.

**Q4. 아이폰을 차량 USB 포트로 충전하면 왜 매우 느린가요?**
차량 내 USB-A 포트는 대부분 5W(5V 1A) 수준이며, USB-C 포트라도 PD 미지원이면 10~18W에 그칩니다. 차량 충전 시 빠른 속도를 원한다면 시가잭(12V) 연결 PD 지원 어댑터를 별도로 구입하는 것이 효과적입니다.

**Q5. 충전기 브랜드(Anker, Belkin, Ugreen 등)에 따라 아이폰 충전 속도가 달라지나요?**
USB-PD 표준을 준수하는 제품이라면 브랜드 간 충전 속도 차이는 미미합니다. 다만 저가 무인증 제품은 PD 협상 안정성이 낮아 실제 수신 전력이 일정하지 않을 수 있습니다. Anker, Belkin, Ugreen 등 주요 브랜드 제품은 대부분 안정적입니다.
